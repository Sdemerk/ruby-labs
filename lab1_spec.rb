...
RSpec.describe "Greeting" do
    ...
    it 'When the age is the less then 18' do
        ...
        expect(Greeting.greeting("Sergei", "Martcenyuk", 17)).to eq"Oh, hello there, Sergei Martcenyuk. You are under 18, but it's never too early to learn to program! :з"
    
    end
    
    it 'When the age is the more then 18' do
       
        expect(Greeting.greeting("Sergei", "Martcenyuk", 19)).to eq"Oh, hello there, Sergei Martcenyuk. It's time to get busy!"
